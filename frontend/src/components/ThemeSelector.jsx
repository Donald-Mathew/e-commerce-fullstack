...
function ThemeSelector() {
    ...
    console.log(theme);
  return (
    <div className='dropdown drop-down-end'>
      {/* DROPDOWN TRIGGER */}
      ...
      <div tabIndex={0}
         className='dropdown-content mt-2 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-2xl w-56 border border-base-content/10 right-[-83px]'
      >
        {/* THEMES */}
